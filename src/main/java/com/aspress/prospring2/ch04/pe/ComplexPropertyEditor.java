...
public class ComplexPropertyEditor extends PropertyEditorSupport {
	...
	private static final Pattern COMPLEX_PATTERN = Pattern.compile("([+\\-])?([0-9.]+)([j]?)", Pattern.CASE_INSENSITIVE);
	...
	public void setAsText(String s) throws IllegalArgumentException {
		...
		if(re==null && im==null) {
			throw new IllegalArgumentException("cannot convert value "+ s+ " to "+Complex.class.getName());
		} else {
