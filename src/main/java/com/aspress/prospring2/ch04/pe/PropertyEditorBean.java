...
public class PropertyEditorBean {
	...
	public static void main(String[] args) {
		BeanFactory factory = new XmlBeanFactory(new ClassPathResource("/META-INF/ch04/pedemo-context.xml"));
		PropertyEditorBean bean = (PropertyEditorBean) factory.getBean("builtInSample");
	}
